        ...
        <div className="flex flex-wrap">
          <div className="w-full xs:w-2/5 mb-1 xs:mb-69 px-4">
            <Image
              ...
              height={150}
              alt=""
              className="py-4 mx-auto xs:mx-0"
            />
            <p
              className={`mb-4 ${DanaRegular.className} text-justify text-xs mb-2 leading-7`}
            >
            ...
            <h4
              className={`${DanaBold.className} mb-4 font-bold text-white text-xl xs:block hidden`}
            >
              عضویت در خبرنامه
            </h4>
          ...
          <div className="w-full xs:w-1/5 mb-6 xs:mb-0 xs:px-4 px-4">
            <h4
              className={`${DanaBold.className} text-white font-bold mb-3 text-xl`}
            >
              خدمات ما
            </h4>
            <hr className="opacity-15 mb-3" />
            <ul className="flex flex-wrap xs:block">
              <Link href={"/"}>
                <li
                  className={`${DanaRegular.className} mb-4 cursor-pointer flex items-center text-sm w-full xs:w-1/2`}
                >
              ...
              <Link href={"/"}>
                <li
                  className={`${DanaRegular.className} mb-4 cursor-pointer flex items-center text-sm w-full xs:w-1/2 mr-8 xs:mr-0`}
                >
                  <span className="w-2 h-2 bg-white rounded-full inline-block ml-2"></span>
                  سِئو و بهینه سازی
                </li>
              ...
              <Link href={"/"}>
                <li
                  className={`${DanaRegular.className} mb-4 flex items-center cursor-pointer text-sm w-full xs:w-1/2 mr-10 xs:mr-0`}
                >
                  <span className="w-2 h-2 bg-white rounded-full inline-block ml-2"></span>
                  بهینه‌سازی سرعت
                </li>
              ...
              <Link href={"/"}>
                <li
                  className={`${DanaRegular.className} mb-4 flex items-center cursor-pointer text-sm w-full xs:w-1/2`}
                >
                  <span className="w-2 h-2 bg-white rounded-full inline-block ml-2"></span>
                  تبلیغات کلیدی
                </li>
              ...
              <Link href={"/"}>
                <li
                  className={`${DanaRegular.className} flex items-center cursor-pointer text-sm w-full xs:w-1/2 mr-8 xs:mr-0`}
                >
                  <span className="w-2 h-2 bg-white rounded-full inline-block ml-2"></span>
                  پشتیبانی وبسایت
                </li>
          ...
          <div className="w-full md:w-1/5 mb-6 md:mb-0 xs:px-4 xs:block hidden ">
            ...
            <ul>
              <Link href={"/"}>
                <li
                  className={`${DanaRegular.className} mb-4 cursor-pointer flex items-center text-sm`}
                >
                  <span className="w-2 h-2 bg-white rounded-full inline-block ml-2"></span>
                  صفحه اصلی
                </li>
              ...
              <Link href={"/"}>
                <li
                  className={`${DanaRegular.className} cursor-pointer flex items-center text-sm`}
                >
                  <span className="w-2 h-2 bg-white rounded-full inline-block ml-2"></span>
                  تماس با ما
                </li>
          ...
          <div className="w-full xs:w-1/5 px-4 xs:px-4">
            ...
            <p
              className={`${DanaMedium.className} mb-2 text-sm flex items-center`}
            >
              <RoomOutlinedIcon className="text-sm ml-1" />
              آدرس : تهران منطقه 18 یافت آباد
            </p>
            <p
              className={`${DanaRegular.className} mb-2 flex items-center text-xs`}
            >
