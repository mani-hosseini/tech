  ...
  return (
    <div className="py-2">
      <Image
        ...
        height={100}
        alt=""
        className="w-full h-[480px] rounded-2xl align-middle object-cover object-center mb-4"
      />
      <div className="flex items-start justify-between">
        <div className="flex items-center">
          <span
            className={`${DanaBold.className}text-[#9D9D9D] text-[14px] opacity-70 flex items-center`}
          >
          ...
          <Link href={"/"}>
            <span
              className={`${DanaBold.className}text-[#9D9D9D] text-[14px] opacity-70 flex items-center mr-4`}
            >
        ...
        <div className="flex items-center">
          <FacebookOutlinedIcon className="text-[#716F87] text-[18px] cursor-pointer ml-2 hover:text-blue-500" />
          <TwitterIcon className="text-[#716F87] text-[18px] cursor-pointer ml-2 hover:text-blue-500" />
          <TelegramIcon className="text-[#716F87] text-[18px] cursor-pointer ml-2 hover:text-blue-500" />
          <WhatsAppIcon className="text-[#716F87] text-[18px] cursor-pointer ml-2 hover:text-blue-500" />
        </div>
      </div>
      ...
      <p className={`${DanaMedium.className} text-justify text-[13.15px] leading-7 text-gray-500`}>
